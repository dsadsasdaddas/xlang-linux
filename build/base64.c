...
int32_t main(int argc, char** argv) {
    ...
    bool decode = false;
    if (((__xlang_argc_g) >= 2)) {
        if ((strcmp(__xlang_argv_g[1], "-d") == 0)) {
            (decode = true);
        }
    }
    const char * s = __xlang_read_stdin();
    int32_t n = (int32_t)strlen(s);
    __xlang_sb_new();
    if (decode) {
        int32_t i = 0;
        ...
        int32_t acc = 0;
        while ((i < n)) {
            int32_t v = b64_val((int32_t)(unsigned char)(s[i]));
            if ((v >= 0)) {
                (acc = ((acc << 6) | v));
                (quad = (quad + 1));
                if ((quad == 4)) {
                    __xlang_sb_push_char((acc >> 16));
                    __xlang_sb_push_char(((acc >> 8) & 255));
                    __xlang_sb_push_char((acc & 255));
                    (quad = 0);
                    (acc = 0);
                }
            }
        ...
        if ((quad == 2)) {
            __xlang_sb_push_char(((acc >> 4) & 255));
        }
        if ((quad == 3)) {
            __xlang_sb_push_char(((acc >> 10) & 255));
            __xlang_sb_push_char(((acc >> 2) & 255));
        }
    } else {
        const char * table = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
        int32_t i = 0;
        while ((i < n)) {
            int32_t b0 = (int32_t)(unsigned char)(s[i]);
            int32_t b1 = 0;
            int32_t b2 = 0;
            bool have1 = ((i + 1) < n);
            bool have2 = ((i + 2) < n);
            if (have1) {
                (b1 = (int32_t)(unsigned char)(s[(i + 1)]));
            }
            if (have2) {
                (b2 = (int32_t)(unsigned char)(s[(i + 2)]));
            }
            int32_t idx0 = (b0 >> 2);
            int32_t idx1 = (((b0 & 3) << 4) | (b1 >> 4));
            int32_t idx2 = (((b1 & 15) << 2) | (b2 >> 6));
            int32_t idx3 = (b2 & 63);
            __xlang_sb_push_char((int32_t)(unsigned char)(table[idx0]));
            __xlang_sb_push_char((int32_t)(unsigned char)(table[idx1]));
            if (have1) {
                __xlang_sb_push_char((int32_t)(unsigned char)(table[idx2]));
            } else {
                __xlang_sb_push_char(61);
            }
            if (have2) {
                __xlang_sb_push_char((int32_t)(unsigned char)(table[idx3]));
            } else {
                __xlang_sb_push_char(61);
            }
            (i = (i + 3));
